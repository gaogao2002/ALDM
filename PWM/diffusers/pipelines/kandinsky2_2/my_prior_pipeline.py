...
from ...models import PriorTransformer,MyPriorTransformer
...
class MyKandinskyPriorPipeline(DiffusionPipeline):
    """
    ...
    def _encode_prompt(
        ...
        # prompt_embeds = prompt.repeat_interleave(num_images_per_prompt, dim=0)
        # print('1111', prompt_embeds.shape)

        if do_classifier_free_guidance:
            prompts = prompt.repeat(1, num_images_per_prompt, 1)
            prompts = prompts.view(batch_size * num_images_per_prompt, s_seq_len, -1)  # 4,64,1024
            ...
            # print('22222', prompt_embeds.shape)
        else:
            prompts = prompt.repeat(1, num_images_per_prompt, 1)
            prompt_embeds = prompts.view(batch_size * num_images_per_prompt, s_seq_len, -1)  # 4,64,1024
